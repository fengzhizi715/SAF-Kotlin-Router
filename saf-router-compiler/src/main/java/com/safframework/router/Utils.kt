 ...
 */
fun isPublic(annotatedClass: TypeElement): Boolean = annotatedClass.modifiers.contains(Modifier.PUBLIC)
 ...
 */
fun isAbstract(annotatedClass: TypeElement): Boolean = annotatedClass.modifiers.contains(Modifier.ABSTRACT)
